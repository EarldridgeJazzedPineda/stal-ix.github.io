...
*This installation method is NOT recommended for beginners (but mandatory for architectures other than x86 (64-bit)). If you don't have the time for bootstrapping and have an x86 (64-bit) computer, use the [rootfs installation method](INSTALL.md) instead.*
